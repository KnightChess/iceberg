 ...
 * the rewrite plan.
 */
object RewriteDeleteFromIcebergTable extends RewriteRowLevelCommand {
  ...
  private def buildWriteDeltaPlan(
    ...
    // construct a read relation and include all required metadata columns
    val readRelation = buildReadRelation(relation, operationTable, rowIdAttrs ++ metadataAttrs)
